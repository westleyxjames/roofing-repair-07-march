...
function setActiveNavLink() {
  ...
  navLinks.forEach(link => {
    ...
    if (currentPath === href || (href !== '/index.html' && href !== '/' && currentPath.includes(href))) {
      link.classList.add('active');
    } else if ((currentPath === '/' || currentPath === '/index.html') && (href === '/' || href === '/index.html')) {
      link.classList.add('active');
    }
  });
}
...
function createIcon(type) {
  const icons = {
    ...
    wrench: '<svg class="icon" viewBox="0 0 24 24"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg>',
    trendingUp: '<svg class="icon" viewBox="0 0 24 24"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>',
